...
int main(int argc, char* argv[])
{
	...
	for (auto ad = 1; ad < argc; ++ad) ////** auto°¡ ¹¹Áö?
	{
		...
		while (!in.eof())//The eof() method of ios class in C++ is used to check if the stream is has raised any EOF (End Of File) error.
		{
